...
ShaderProgram::ShaderProgram(const std::vector<std::pair<GLenum,const std::string&>>& sources,  const std::string& name, const std::vector<std::string>& tf_outs) :
	name_(name)
{
...
SP_ShaderProgram ShaderProgram::create(const std::vector<std::pair<GLenum,const std::string&>>& sources,  const std::string& name,const std::vector<std::string>& tf_outs)
{
	auto shp = std::make_shared<ShaderProgram>(sources,name,tf_outs);
	GLint status;
