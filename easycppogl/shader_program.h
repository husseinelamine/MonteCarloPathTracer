...
public:
	...
	ShaderProgram(const std::vector<std::pair<GLenum,const std::string&>>& sources,  const std::string& name, const std::vector<std::string>& tf_outs = { });
	...
	static SP_ShaderProgram create(const std::vector<std::pair<GLenum,const std::string&>>& sources,  const std::string& name, const std::vector<std::string>& tf_outs= {});
	...
	inline void set_uniform_val(GLint unif, const GLVVec2& v) { glUniform2fv(utranslat[unif],GLint(v.size()),v[0].data());}
	inline void set_uniform_val(GLint unif, const GLVVec3& v) { glUniform3fv(utranslat[unif], GLint(v.size()),v[0].data());}
	inline void set_uniform_val(GLint unif, const GLVVec4& v) { glUniform4fv(utranslat[unif], GLint(v.size()),v[0].data());}

	inline void set_uniform_val(GLint unif, const std::vector<GLMat2>& v) { glUniformMatrix2fv(utranslat[unif], GLint(v.size()), false, v[0].data());}
	inline void set_uniform_val(GLint unif, const std::vector<GLMat3>& v) { glUniformMatrix3fv(utranslat[unif], GLint(v.size()), false, v[0].data());}
	inline void set_uniform_val(GLint unif, const std::vector<GLMat4>& v) { glUniformMatrix4fv(utranslat[unif], GLint(v.size()), false, v[0].data());}
